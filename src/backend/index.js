...
app.listen(5500, function () {
  ...
  console.log('API available at http://localhost:5500/api/posts');
});

// ============================================
// Legacy EJS Routes (can be removed once React is working)
// ============================================
...
// API route - GET /listjson - Return posts as JSON (legacy endpoint)
